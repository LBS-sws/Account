...
<section class="content">
        ...
        <div class="box-body">
            <div class="btn-group" role="group">
                ...
                <?php if (Yii::app()->user->validFunction('CN12') && $model->examine == 'Y') { ?>
                    ...
                    ?>
                <?php } else {
                    if ($model->examine == 'S' || $model->examine == 'N') echo TbHtml::button('<span class="fa fa-upload"></span> ' . Yii::t('misc', 'Approval'), array(
    ...
    <div class="box box-info">
        <h3>
            &nbsp;&nbsp;&nbsp;<?php echo $model->year . "年" . $model->month . "月" . ' ' . $model->sale . "提成表" . "(" . $model->examine . ")"; ?></h3>
        <div class="box-body">
            ...
            <div class="form-group" style="margin-left: 2px;">
                ...
                <div class="form-group">
                    ...
                    <?php if ($model->examine == 'S') {
                        echo $form->labelEx($model, 'ject_remark', array('class' => "col-sm-2 control-label")); ?>
                        <div class="col-sm-4">
                ...
                <table class="tftable" border="1">
                    <tr>
                        ...
                        <th colspan="4">IA（清洁）</th>
                        <th colspan="4">IB（灭虫）</th>
                        <th colspan="4">IC（租机）</th>
                        <th rowspan="2">焗雾/白蚁/甲醛/雾化消毒</th>
                        <th rowspan="2">I（装机费）</th>
                        <th colspan="7">销售</th>
                    </tr>
                    <tr>
                        <th>IA费/月</th>
                    ...
                    <tr style="background-color: #acc8cc">
                        <td></td>
                        <td>月营业额</td>
                        <td><?php echo $model->ia; ?></td>
                        <td><?php echo $model->ia_c; ?></td>
                        <td><?php echo $model->ia_end; ?></td>
                        <td><?php echo $model->ia_c_end; ?></td>
                        <td><?php echo $model->ib; ?></td>
                        <td><?php echo $model->ib_c; ?></td>
                        <td><?php echo $model->ib_end; ?></td>
                        <td><?php echo $model->ib_c_end; ?></td>
                        <td><?php echo $model->ic; ?></td>
                        <td><?php echo $model->ic_c; ?></td>
                        <td><?php echo $model->ic_end; ?></td>
                        <td><?php echo $model->ic_c_end; ?></td>
                        <td><?php echo $model->amt_paid; ?></td>
                        <td><?php echo $model->amt_install; ?></td>
                        <td><?php echo $model->paper; ?></td>
                        <td><?php echo $model->disinfectant; ?></td>
                        <td><?php echo $model->purification; ?></td>
                        <td><?php echo $model->chemical; ?></td>
                        <td><?php echo $model->aromatherapy; ?></td>
                        <td><?php echo $model->pestcontrol; ?></td>
                        <td><?php echo $model->other; ?></td>
                    </tr>
                    <tr style="background-color: #acc8cc">
                        <td></td>
                        <td>年营业额</td>
                        <td><?php echo $model->y_ia; ?></td>
                        <td><?php echo $model->y_ia_c; ?></td>
                        <td><?php echo $model->y_ia_end; ?></td>
                        <td><?php echo $model->y_ia_c_end; ?></td>
                        <td><?php echo $model->y_ib; ?></td>
                        <td><?php echo $model->y_ib_c; ?></td>
                        <td><?php echo $model->y_ib_end; ?></td>
                        <td><?php echo $model->y_ib_c_end; ?></td>
                        <td><?php echo $model->y_ic; ?></td>
                        <td><?php echo $model->y_ic_c; ?></td>
                        <td><?php echo $model->y_ic_end; ?></td>
                        <td><?php echo $model->y_ic_c_end; ?></td>
                        <td><?php echo $model->y_amt_paid; ?></td>
                        <td><?php echo $model->amt_install; ?></td>
                        <td colspan="7"><?php echo $model->all_sale; ?></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td>新客户IA/IB/IC营业额</td>
                        <td colspan="22"><?php echo $model->abc_money; ?></td>
                    </tr>
                    <tr>
                        <td rowspan="2">名称</td>
                        <td rowspan="2"></td>
                        <td colspan="12">本月新客户营业提成</td>
                        <td colspan="2">本月续约营业提成</td>
                        <td colspan="8">本月扣除停止客户营业提成</td>
                    </tr>
                    <tr>
                        <td colspan="2">IA（清洁）</td>
                        <td colspan="2">IB（灭虫）</td>
                        <td colspan="2">焗雾/白蚁/甲醛/雾化消毒</td>
                        <td colspan="1">IC（租机）</td>
                        <td colspan="2">I（装机费）</td>
                        <td>销售</td>
                        <td colspan="2">化学剂（洗地易）</td>
                        <td colspan="2">续约</td>
                        <td colspan="2">IA（清洁）</td>
                        <td colspan="2">IB（灭虫）</td>
                        <td colspan="2">IC（租机）</td>
                        <td>续约</td>
                    </tr>
                    <tr>
                        <td>提成点数</td>
                        <td></td>
                        <td colspan="2"><?php echo $model->ia_royalty . "%"; ?></td>
                        <td colspan="2"><?php echo $model->ib_royalty . "%"; ?></td>
                        <td colspan="2"><?php echo $model->amt_paid_royalty . "%"; ?></td>
                        <td colspan="1"><?php echo $model->ic_royalty . "%"; ?></td>
                        <td colspan="2"><?php $a = $model->amt_install_royalty * 100;
                            echo $a . "%"; ?></td>
                        <td><?php echo $model->sale_royalty; ?></td>
                        <td colspan="2"><?php echo $model->huaxueji_royalty . "%"; ?></td>
                        <td colspan="2"><?php echo $model->xuyue_royalty . "%"; ?></td>
                        <td colspan="2">/</td>
                        <td colspan="2">/</td>
                        <td colspan="2">/</td>
                        <td>1%</td>
                    </tr>
                    <tr style="background-color: #bedda7">
                        <td>金额</td>
                        <td></td>
                        <td colspan="2"><?php echo $model->ia_money; ?></td>
                        <td colspan="2"><?php echo $model->ib_money; ?></td>
                        <td colspan="2"><?php echo $model->amt_paid_money; ?></td>
                        <td colspan="1"><?php echo $model->ic_money; ?></td>
                        <td colspan="2"><?php echo $model->amt_install_money; ?></td>
                        <td><?php echo $model->sale_money; ?></td>
                        <td colspan="2"><?php echo $model->huaxueji_money; ?></td>
                        <td colspan="2"><?php echo sprintf("%.2f",$model->xuyue_money); ?></td>
                        <td colspan="2"><?php echo $model->ia_end_money; ?></td>
                        <td colspan="2"><?php echo $model->ib_end_money; ?></td>
                        <td colspan="2"><?php echo $model->ic_end_money; ?></td>
                        <td><?php echo $model->xuyuezhong_money; ?></td>
                    </tr>
                    <tr style="background-color: #acc8cc">
                        <td>金额合计</td>
                        <td></td>
