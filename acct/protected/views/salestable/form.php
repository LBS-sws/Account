		...
		<div class="box-body">
            ...
            <div class="form-group" style="margin-left: 2px;">
                ...
                <table class="tftable" border="1" >
                    ...
                    <tr <?php if($value['othersalesman']==1){echo "style='color: red'";}if($value['othersalesman']==2){echo "style='color: green'";}?>><td><?php echo $value['status_dt'];?></td><td><?php echo $value['company_name'];?></td><td><?php echo $value['ia'];?></td><td><?php echo $value['ia_c'];?></td><td><?php echo $value['ia_end'];?></td><td><?php echo $value['ia_c_end'];?></td><td><?php echo $value['ib'];?></td><td><?php echo $value['ib_c'];?></td><td><?php echo $value['ib_end'];?></td><td><?php echo $value['ib_c_end'];?></td><td><?php echo $value['ic'];?></td><td><?php echo $value['ic_c'];?></td><td><?php echo $value['ic_end'];?></td><td><?php echo $value['ic_c_end'];?></td><td><?php echo $value['amt_paid'];?></td><td><?php echo $value['amt_install'];?></td><td><?php echo $value['paper'];?></td><td><?php echo $value['disinfectant'];?></td><td><?php echo $value['purification'];?></td><td><?php echo $value['chemical'];?></td><td><?php echo $value['aromatherapy'];?></td><td><?php echo $value['pestcontrol'];?></td><td><?php echo $value['other'];?></td></tr>
                    <?php }}?>
