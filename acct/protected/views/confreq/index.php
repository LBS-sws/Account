<?php
$this->pageTitle=Yii::app()->name . ' - Payment Request Confirmation';
?>
...
<section class="content-header">
	<h1>
		<strong><?php echo Yii::t('trans','Request Confirmation'); ?></strong>
	</h1>
<!--
	<ol class="breadcrumb">
...
<?php if (Yii::app()->user->validFunction('CN07')) : ?>
	...
	<div class="btn-group" role="group">
		<?php 
			echo TbHtml::button('<span class="fa fa-check"></span> '.Yii::t('trans','Batch Confirm'), array(
				'id'=>'btnBatchAppr', 
			)); 
		?>
<?php 
...
<?php endif ?>
	...
	<?php 
		...
		$this->widget('ext.layout.ListPageWidget', array(
			...
			'model'=>$model,
				'viewhdr'=>'//confreq/_listhdr',
				'viewdtl'=>'//confreq/_listdtl',
				'search'=>$search,
		));
...
$link = Yii::app()->createAbsoluteUrl("confreq");
$js = <<<EOF
...
$url = Yii::app()->createUrl('confreq/batchapprove');
$js = "
