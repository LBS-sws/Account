<?php
$this->pageTitle=Yii::app()->name . ' - ExpenseAudit Form';
?>

<?php $form=$this->beginWidget('TbActiveForm', array(
'id'=>'ExpenseAudit-form',
...
$this->widget('bootstrap.widgets.TbModal', array(
    ...
    'content'=>$content,
    'footer'=>array(
        TbHtml::button(Yii::t('dialog','OK'), array('color'=>TbHtml::BUTTON_COLOR_PRIMARY,'submit'=>Yii::app()->createUrl('expenseAudit/reject'))),
