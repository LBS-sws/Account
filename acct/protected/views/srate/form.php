...
<section class="content-header">
	<h1>
		<strong><?php echo Yii::t('service','Service Rate Form'); ?></strong>
	</h1>
</section>
...
<section class="content">
	...
	<div class="btn-group" role="group">
		<?php echo TbHtml::button('<span class="fa fa-reply"></span> '.Yii::t('misc','Back'), array(
				'submit'=>Yii::app()->createUrl('srate/index'))); 
		?>
...
<div class="box-body table-responsive">
			<?php 
				$this->widget('ext.layout.TableView2Widget', array(
					'model'=>$model,
					'attribute'=>'detail',
					'viewhdr'=>'//srate/_formhdr',
					'viewdtl'=>'//srate/_formdtl',
				));
			?>
</div>			
</div>			
...
<?php
$js = "
$('table').on('change','[id^=\"SRateForm\"]',function() {
	var n=$(this).attr('id').split('_');
	$('#SRateForm_'+n[1]+'_'+n[2]+'_uflag').val('Y');
});
";
...
$('#btnAddRow').on('click',function() {
	...
	if (r>0) {
		...
		$('#tblDetail tr').eq(-1).find('[id*=\"SRateForm_\"]').each(function(index) {
			var id = $(this).attr('id');
