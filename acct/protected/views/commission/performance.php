...
<section class="content-header">
	<h1>
        <strong><?php echo Yii::t('app','Spanning Sales New Commission'); ?></strong>
	</h1>
<!--
	<ol class="breadcrumb">
...
//            ?>
            ...
            <?php echo TbHtml::button('<span class="fa fa-upload"></span> '.Yii::t('misc','Clear'), array(
                    'submit'=>Yii::app()->createUrl('commission/clear',array('year'=>$year,'month'=>$month,'index'=>$index,'clear'=>'performance')))
            ); ?>
        </div>
    </div>
</div>
