...
<section class="content-header">
	<h1>
        <strong><?php echo Yii::t('app','Spanning Sales Edit Commission'); ?></strong>
	</h1>
<!--
	<ol class="breadcrumb">
...
//            ?>
            <?php  echo TbHtml::button('<span class="fa fa-upload"></span> '.Yii::t('misc','Save1'), array(
                    'submit'=>Yii::app()->createUrl('commission/performanceeditsave',array('year'=>$year,'month'=>$month,'index'=>$index)))
            ); ?>
            <?php echo TbHtml::button('<span class="fa fa-upload"></span> '.Yii::t('misc','Clear'), array(
                    'submit'=>Yii::app()->createUrl('commission/clear',array('year'=>$year,'month'=>$month,'index'=>$index,'clear'=>'performanceedit')))
            ); ?>
        </div>
    </div>
</div>
