<?php
$this->pageTitle=Yii::app()->name . ' - RemitPayment Form';
?>

<?php $form=$this->beginWidget('TbActiveForm', array(
'id'=>'RemitPayment-form',
...
<?php endif ?>
	...
	<div class="box box-info">
		<div class="box-body">
            ...
            <?php $this->renderPartial('//remitApply/remitAcc',array("model"=>$model,"form"=>$form)); ?>
...
$this->widget('bootstrap.widgets.TbModal', array(
    ...
    'content'=>$content,
    'footer'=>array(
        TbHtml::button(Yii::t('dialog','OK'), array('color'=>TbHtml::BUTTON_COLOR_PRIMARY,'submit'=>Yii::app()->createUrl('remitPayment/reject'))),
...
$this->widget('bootstrap.widgets.TbModal', array(
    ...
    'content'=>$content,
    'footer'=>array(
        TbHtml::button(Yii::t('dialog','OK'), array('color'=>TbHtml::BUTTON_COLOR_PRIMARY,'submit'=>Yii::app()->createUrl('remitPayment/shift'))),
        TbHtml::button(Yii::t('dialog','Cancel'), array('data-dismiss'=>'modal','color'=>TbHtml::BUTTON_COLOR_PRIMARY)),
    ),
    'show'=>false,
));
