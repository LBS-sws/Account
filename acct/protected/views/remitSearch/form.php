<?php
$this->pageTitle=Yii::app()->name . ' - RemitSearch Form';
?>
...
<?php endif ?>
            ...
            <div class="btn-group pull-right" role="group">
                <?php if (in_array($model->status_type,array(4,6,9))): ?>
                    <?php echo TbHtml::link('<span class="fa fa-print"></span> '.Yii::t('invoice','print'),Yii::app()->createUrl('remitSearch/print',array("index"=>$model->id)), array(
...
$this->widget('bootstrap.widgets.TbModal', array(
    ...
    'content'=>$content,
    'footer'=>array(
        TbHtml::button(Yii::t('dialog','OK'), array('color'=>TbHtml::BUTTON_COLOR_PRIMARY,'submit'=>Yii::app()->createUrl('remitSearch/reject'))),
