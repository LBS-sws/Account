...
<?php endif ?>
			...
			<div class="form-group">
				<?php echo $form->labelEx($model,'charge_item',array('class'=>"col-sm-2 control-label")); ?>
				<div class="col-sm-4">
					<?php echo $form->dropDownList($model, 'charge_item', General::getAcctCodeList(),array('disabled'=>($model->isReadOnly()))); ?>
				</div>
			</div>
