<tr class='clickable-row' data-href='<?php echo $this->getLink('XE03', 'transout/view', 'transout/view', array('index'=>$this->record['id']));?>'>
	<td><?php echo $this->drawEditButton('XE03', 'transout/view', 'transout/view', array('index'=>$this->record['id'])); ?></td>
