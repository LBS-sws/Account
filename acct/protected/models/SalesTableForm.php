...
//            'amt_install_royalty'=>Yii::t('service','Name'),
	...
	public function retrieveData($index)
	{
        ...
        $sql1 = "select paid_type,amt_paid,ctrt_period,b4_amt_paid,cust_type_name,status_dt,company_name,status,commission,other_commission,amt_install,othersalesman,cust_type,service
                  from swoper$suffix.swo_service where((status_dt<='$end' and  status_dt>='$start') or (first_dt<='$end' and  first_dt>='$start')) and (salesman='$a1' or  othersalesman='$a1')
                  union
                  ...
                  from acc_service_comm_copy where ((status_dt<='$end' and  status_dt>='$start') or (first_dt<='$end' and  first_dt>='$start')) and (salesman='$a1' or  othersalesman='$a1')
";
        //  ((commission!=' ' and commission!=0) or (other_commission!=0 and other_commission!=' ')) and
        // ((commission!=' ' and commission!=0) or (other_commission!=0 and other_commission!=' ')) and
