...
class RemitSearchList extends CListPageModel
{
	/**
	...
	public function retrieveDataByPage($pageNum=1)
	{
		...
		$sql1 = "select a.*,g.name as city_name,f.name as department_name,b.code as employee_code,b.name as employee_name 
				...
				where a.status_type!=0 and a.table_type=2 and (a.city in ({$city_allow}) or FIND_IN_SET('{$uid}',a.audit_user))
			";
		...
		$session['remitSearch_c01'] = $this->getCriteria();
		return true;
	}
}
