...
//        $sql="insert into acc_invoice (dates,payment_term,customer_po_no,customer_account,salesperson,sales_order_no,sales_order_date,ship_via,invoice_company,invoice_address,invoice_tel,delivery_company,delivery_address,delivery_tel,description,quantity,unit_price,disc,amount,sub_total,gst,total_amount,generated_by,lcu,luu) value ()";
                    ...
                    if(!empty($id)){
                        ...
                        Yii::app()->db->createCommand()->update("acc_invoice",array(
                            ...
                            'page_num'=>$number,
                            'remarks'=>$remarks,
                        ),"id=:id",array(":id"=>$id));//修改發票的總金額及特別說明
                    }
                }
            }
        }
		...
		switch ($this->scenario) {
			...
			case 'edit':
				$sql = "update acc_invoice set
                            ...
                            invoice_to_addr=:invoice_to_addr,                                                                                                              
                            invoice_to_tel=:invoice_to_tel,                                                                                                              
                            name_zh=:name_zh,                                                                                                              
                            addr=:addr,                                                                                                              
                            tel=:tel,                                                                                                              
                            remarks=:remarks,                                                                                                              
...
//812px *572
        //LBS信息
        $html.='
<table border="0" width="812px" cellspacing="0" cellpadding="0">
	<tr>
		<td width="180px"> </td>
		<td width="148px" rowspan="6" style="text-align: left;"><img width="106px"  src="images/lbs_pdf.jpg" ></td>
		<td width="119px" rowspan="6" style="text-align: center;color:red;font-size: 20px;">發票<br>INVOICE</td>
		<td width="180px" style="font-weight: bold;">寄往</td>
		<td width="215px" style="font-weight: bold;">REMIT TO:</td>
	</tr>
	<tr>
		<td rowspan="5">
		    <span style="color:red;font-weight: bold;">發票編號</span><br>
		    <span style="font-weight: bold;">INVOICNE NO.</span><br>
		    <span style="'.$info_style.'">  '.$model->invoice_no.'</span>
		</td>
		<td><span style="font-size:10px;">史偉莎澳門(由佳駿企業有限公司經營)</span></td>
		<td><span style="font-size:10px;">LBS Macau (O/B Kai Jun Enterprises Ltd.)</span></td>
	</tr>
	<tr>
		<td><span style="font-size:10px;">澳門慕拉士大馬路一八五至一九一號</span></td>
		<td><span style="font-size:10px;">Avenida Venceslau de Morais NO185 - 191,</span></td>
	</tr>
	<tr>
		<td><span style="font-size:10px;">澳門工業中心十樓B座</span></td>
		<td><span style="font-size:10px;">10 Andar B Ed Centro Industrial Macau, Macau</span></td>
	</tr>
	<tr>
		<td><span style="font-size:10px;">電話：(853) 2871 9588 傳真：2871 9727</span></td>
		<td><span style="font-size:10px;">Tel.: (853) 2871 9588 Fax: 2871 9727</span></td>
	</tr>
	<tr>
		<td><span style="font-size:10px;color:red;">(支票抬頭 “佳駿企業有限公司”)</span></td>
		<td><span style="font-size:10px;color:red;">(Cheque payable to“Kai Jun Enterprises Ltd.”)</span></td>
	</tr>
</table>
';
        ...
        //客戶信息
        $html.='
<table border="0" width="812px" cellspacing="0" cellpadding="0" style="line-height: 11px;">
	...
	<tr>
		<td>
			...
			<span style="font-size: 9px;">ALL MACHINES ARE FURNISHED FOR SERVICE ONLY AND REMAIN THE PROPERTY OF LBS HYGIENE SERVICES.</span>
		</td>
		<td> </td>
		<td colspan="4">
			<span style="color: red;">史偉莎澳門之滅蟲服務員已清楚闡明及警告處理老鼠藥餌之方法並已於有擺放藥餌之位置貼上警告標貼。（只適用於採用滅鼠服務之客戶）</span><br/>
			<span style="font-size: 9px;">THIS IS TO ACKNOWLEDGE THAT LBS MACAU PEST CONTROL OFFICER DID EXPLAIN AND PUT WARNING LABELS REGARDING RODENT BAITS AT BAITING LOCATIONS.(ONLY APPLICABLE TO CUSTOMERS WITH RODENT CONTROL SERVICE)</span>
		</td>
	</tr>
	<tr>
		<td style="border-top: 2px solid black;border-bottom: 2px solid black;">
		    <span style="width: 4px;"></span>
			<span style="color: red;line-height: 20px;">產品名稱</span><br/>
			<span>DESCRIPTION</span>
		</td>
		<td style="border-top: 2px solid black;border-bottom: 2px solid black;"> </td>
		<td style="border-top: 2px solid black;border-bottom: 2px solid black;">
		    <span style="width: 4px;"></span>
			<span style="color: red;line-height: 20px;">數量</span><br/>
			<span>QUANTITY</span>
		</td>
		<td style="border-top: 2px solid black;border-bottom: 2px solid black;text-align: center;">
<span style="color: red;line-height: 20px;">單價</span><br/>
			<span>UNIT PRICE</span>
		</td>
		<td width="120px" style="border-top: 2px solid black;border-bottom: 2px solid black;text-align: right;">
		    <span style="color: red;line-height: 20px;">金額     </span><br/>
			<span>AMOUNT</span>
		</td>
		<td width="10px" style="border-top: 2px solid black;border-bottom: 2px solid black;"> </td>
	</tr>
</table>
';
        //特別說明及付款碼
        $html.='
<table border="0" width="812px" cellspacing="0" cellpadding="0" style="line-height: 10px;">
    <tr><td colspan="3" style="line-height: 140px;"></td></tr>
    <tr>
        <td colspan="3"><span style="color:red;">特別提示</span><br/>
            <span style="font-size: 8px;">SPECIAL INSTRUCTIONS:</span>
        </td>
    </tr>
    <tr>
        <td width="10px;"></td>
...
<table border="0" width="812px" cellspacing="0" cellpadding="0" style="line-height: 10px;">
    <tr>
        <td width="86px" style="color:red;">服務技術員名稱</td>
    ...
    private function insertModelForPDF(&$pdf,$model){
        ...
        $pdf->writeHTMLCell(106,8,42,34,$html,0);
        $html='<span style="'.$info_style.'">'.$model->invoice_to_name.'</span>';
        $pdf->writeHTMLCell(120,8,37,42,$html,0);
        $html='<span style="'.$info_style.'">'.$model->invoice_to_addr.'</span>';
        $pdf->writeHTMLCell(123,22,25,50,$html,0);
        $html='<span style="'.$info_style.'">'.$model->payment_term.'</span>';
        $pdf->writeHTMLCell(95,8,52,72,$html,0);
        if(!empty($model->type)){
            ...
            foreach ($model->type as $row){
                ...
                $html.='<td width="115px" style="text-align: center">'.$row['qty'].'</td>';
                $html.='<td width="38px"> </td>';
                $html.='<td width="150px" style="text-align: center">'.$row['unit_price'].'</td>';
                $html.='<td width="108px" style="text-align: right">'.$row['amount'].'</td>';
                $html.='</tr>';
            }
            $html.='</table>';
            //$w, $h, $x, $y, $html='', $border=0
            $pdf->writeHTMLCell(290,45,5,102,$html,0);
        }
        $remarks = str_replace("\n","<br/>",$model->remarks);
        $html='<span style="'.$info_style.'">'.$remarks.'</span>';
        //$w, $h, $x, $y, $html='', $border=0
        $pdf->writeHTMLCell(240,22,40,149,$html,0);
    }
...
//        $files = array('image.jpeg','text.txt','music.wav');
        ...
        $zip = new ZipArchive;
        $bool = $zip->open($zipname, ZipArchive::CREATE);
        foreach ($files as $file) {
            $result = basename($file);
            $bool = $zip->addFile(sys_get_temp_dir().$file,$result);
        }
        $zip->close();
