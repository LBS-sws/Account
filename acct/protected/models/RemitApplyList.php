...
class RemitApplyList extends CListPageModel
{
	/**
	...
	public function retrieveDataByPage($pageNum=1)
	{
		...
		$sql1 = "select a.*,g.name as city_name,f.name as department_name,b.code as employee_code,b.name as employee_name 
				...
				where a.lcu='{$uid}' and a.table_type=2 
			";
		...
		$session['remitApply_c01'] = $this->getCriteria();
		return true;
	}
    ...
    public function getCountConsult(){
        ...
        $sql = "select count(id)
				from acc_expense 
				where lcu='{$uid}' and table_type=2 and status_type=7  
			";
